...
const classFormSchema = z.object({
  ...
  section: z.string().optional().refine(
    ...
    "Section cannot contain commas. Use 'Add Sections to Grade' for multiple sections."
  ),
...
export default function ClassesPage() {
  ...
  const generateInstantClassesMutation = useMutation({
    ...
    onSuccess: (createdClasses) => {
      ...
      toast({
        title: "Success",
        description: `Successfully generated ${createdClasses.length} classes (Grades 1-12)`,
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  const createSectionsMutation = useMutation({
    ...
    onSuccess: (createdClasses) => {
      ...
      toast({
        title: "Success",
        description: `Successfully created ${createdClasses.length} sections for Grade ${selectedGrade}`,
      });
    },
    onError: (error: Error) => {
      toast({
  ...
  const handleCreateSections = () => {
    ...
    createSectionsMutation.mutate({ grade: selectedGrade, sections });
  };
      ...
      <AlertDialog open={isGenerateDialogOpen} onOpenChange={setIsGenerateDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will automatically generate classes from Grade 1 to Grade 12 for this school. 
