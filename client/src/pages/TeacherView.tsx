...
type TeacherFormData = z.infer<typeof insertTeacherSchema>;
...
export default function TeacherView() {
  ...
  const isActiveDay = timetableStructure?.workingDays?.includes(selectedDayName) || false;
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <SelectContent>
                              {subjects
                                .filter((subject: any) => !field.value.includes(subject.id))
                                .map((subject: any) => (
                  ...
                  <CardContent className="space-y-1 pt-0 pb-3">
                    ...
                    {teacher.contactNumber && (
                      <div className="flex items-center gap-1 text-xs">
                        ...
                        <span className="text-muted-foreground" data-testid={`teacher-contact-${teacher.id}`}>
                          {teacher.contactNumber}
                        </span>
                      </div>
                    )}
                    ...
                    {teacher.schoolIdNumber && (
                      <div className="flex items-center gap-1 text-xs">
                        ...
                        <span className="text-muted-foreground" data-testid={`teacher-school-id-${teacher.id}`}>
                          {teacher.schoolIdNumber}
                        </span>
                      </div>
                    )}
